    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center py-3 px-xl-5">
            ...
            <div class="col-lg-3 col-6 text-right">
                ...
                <a href="<?= base_url('index.php/main/cart')?>" class="btn border">
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
					...
					<?php }  else { ?>
						<div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="<?= site_url('main/dashboard')?>" class="nav-item nav-link active">Beranda</a>
                            <a href="<?php echo site_url('toko'); ?>" class="nav-item nav-link">Toko</a>
                            <a href="detail.html" class="nav-item nav-link">Transaksi</a>
                        </div>
                        <div class="navbar-nav ml-auto py-0">
                            <a href="<?php echo site_url('main/profile_member'); ?>" class="nav-item nav-link">Profile</a>

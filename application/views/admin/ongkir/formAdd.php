  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Form Tambah Ongkos Kirim</h1>
          </div>
          <div class="col-sm-6">
              ...
              <form class="form-horizontal" method="post" action="<?php echo site_url('ongkir/save');?>">
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="tujuan" class="form-control" id="inputEmail3" placeholder="Kota Tujuan" required>
                    </div>
                  </div>
									<div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="ongkos" class="form-control" id="inputEmail3" placeholder="Ongkos Kirim" required>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
